...
const projects: Project[] = [
   {
    ...
    imageUrl: "https://picsum.photos/seed/skillconnect/600/400",
  ...
  },
   {
    ...
    imageUrl: "https://picsum.photos/seed/eatapp/600/400",
  },
   {
    title: "SkillSwap",
    ...
    imageUrl: "https://picsum.photos/seed/skillswap/600/400",
  ...
  },
  {
    ...
    imageUrl: "https://picsum.photos/seed/rideshare/600/400",
  },
   {
    title: "Neatflix",
    ...
    imageUrl: "https://picsum.photos/seed/neatflix/600/400",
  ...
  },
  {
    ...
    imageUrl: "https://picsum.photos/seed/placementprep/600/400",
  },
   {
    title: "ExpensePal",
    ...
    imageUrl: "https://picsum.photos/seed/expensepal/600/400",
  ...
  },
   {
    ...
    imageUrl: "https://picsum.photos/seed/inotes/600/400",
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <Card key={index} className="flex flex-col overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
              {project.imageUrl && (
                  <div className="relative w-full h-48">
                    <Image
                      ...
                      data-ai-hint="app screenshot mobile interface"
                    />
                  </div>
                )}
              <CardHeader>
